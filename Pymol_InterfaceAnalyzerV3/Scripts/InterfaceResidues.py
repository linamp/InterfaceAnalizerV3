...
def interfaceResidues(cmpx, cA='c. A', cB='c. B', cutoff=8, selName="interface"):
	"""
	...
	PARAMS
		...
		cutoff (int, optional): 0 allows the most relaxed selection ofthe interface, higher numbers restrict the interface. Defaults to 8.
